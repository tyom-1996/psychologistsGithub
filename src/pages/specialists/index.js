                ...
                <div className="psychologists_wrapper">
                    <div className='psychologists_info_wrapper'>
                        <p className='psychologists_info'>
                            ...
                            К нам попадают только те, кто горит своей профессией, зхочет помочь людям и сделать мир чуточку лучше. Наши специалисты искренне любят свое дело и регулярно повышают свою квалификацию
                            ...
                            Образование
                            Каждый из наших психологов является дипломированным специалистом с высшим образованием. За квантовой психологией и астрологией точно к нам. 2х недельные курсы не подойдут.
